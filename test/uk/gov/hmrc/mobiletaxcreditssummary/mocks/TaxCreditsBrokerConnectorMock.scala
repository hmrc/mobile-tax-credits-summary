...
trait TaxCreditsBrokerConnectorMock extends MockFactory {
  ...
  val expectedPaymentCTC: FuturePayment =
    FuturePayment(140.12, expectedNextDueDate.atStartOfDay(), oneOffPayment = false)

  val expectedFtnaePaymentCTC: FuturePayment =
    FuturePayment(150.12, paymentWithFtnae.atStartOfDay(), oneOffPayment = false)
  ...
  val paymentSummaryCovid: PaymentSummary =
    PaymentSummary(Some(paymentSectionWTC), Some(paymentSectionCTC), paymentEnabled = Some(true), specialCircumstances = Some("COVID"), informationMessage = Some(InformationMessage("Do not update working hours if you or your partner are working less because of coronavirus (COVID-19)", "We are treating this as a temporary exceptional change. Your Working Tax Credit will not go down because you are working less.\n\nYou can still report other changes in income, childcare and increased hours as normal.\n\nSearch COVID-19 on gov.uk for the latest advice.")))
  ...
  def paymentSummaryMultipleFtnae(
                                   preSeptember: Boolean,
                                   currentYear: Boolean,
                                   ftnae: Boolean = true,
                                   ctc: Boolean = true
  ...
  def mockTaxCreditsBrokerConnectorGetPaymentSummary(
                                                      response: Option[PaymentSummary],
                                                      nino: TaxCreditsNino
                                                    )(implicit taxCreditsBrokerConnector: TaxCreditsBrokerConnector
                                                    ): Unit =
    (taxCreditsBrokerConnector
  ...
  def mockTaxCreditsBrokerConnectorGetPaymentFailure(
                                                      response: Exception,
                                                      nino: TaxCreditsNino
                                                    )(implicit taxCreditsBrokerConnector: TaxCreditsBrokerConnector
                                                    ): Unit =
  ...
  def mockTaxCreditsBrokerConnectorGetChildren(
                                                response: Seq[Child],
                                                nino: TaxCreditsNino
                                              )(implicit taxCreditsBrokerConnector: TaxCreditsBrokerConnector
                                              ): Unit =
  ...
  def mockTaxCreditsBrokerConnectorGetChildrenFailure(
                                                       response: Exception,
                                                       nino: TaxCreditsNino
                                                     )(implicit taxCreditsBrokerConnector: TaxCreditsBrokerConnector
                                                     ): Unit =
  ...
  def mockTaxCreditsBrokerConnectorGetPartnerDetails(
                                                      response: Option[Person],
                                                      nino: TaxCreditsNino
                                                    )(implicit taxCreditsBrokerConnector: TaxCreditsBrokerConnector
                                                    ): Unit =
    (taxCreditsBrokerConnector
  ...
  def mockTaxCreditsBrokerConnectorGetPartnerDetailsFailure(
                                                             response: Exception,
                                                             nino: TaxCreditsNino
                                                           )(implicit taxCreditsBrokerConnector: TaxCreditsBrokerConnector
                                                           ): Unit =
  ...
  def mockTaxCreditsBrokerConnectorGetPersonalDetails(
                                                       response: Person,
                                                       nino: TaxCreditsNino
                                                     )(implicit taxCreditsBrokerConnector: TaxCreditsBrokerConnector
                                                     ): Unit =
  ...
  def mockTaxCreditsBrokerConnectorGetPersonalDetailsFailure(
                                                              response: Exception,
                                                              nino: TaxCreditsNino
                                                            )(implicit taxCreditsBrokerConnector: TaxCreditsBrokerConnector
                                                            ): Unit =
  ...
  def mockTaxCreditsBrokerConnectorGetActualSelfEmployedIncome(
  ...
  def mockTaxCreditsBrokerConnectorGetActualSelfEmployedIncomeFailure(
                                                                       response: Exception,
                                                                       nino: TaxCreditsNino
                                                                     )(implicit taxCreditsBrokerConnector: TaxCreditsBrokerConnector
                                                                     ): Unit =
